...
public class Enemy1 extends EnemyGeneric {
    ...
    public Enemy1(Color color, Vector2D position, Vector2D velocity, double radius, double angle, int health, int damage, long fireCooldown, double explosionStart, double explosionEnd, double dydx) {
